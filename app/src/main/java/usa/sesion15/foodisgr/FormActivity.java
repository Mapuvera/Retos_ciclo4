...
public class FormActivity extends AppCompatActivity {
    ...
    private Button btnChoose,btnInsert,btnEliminar,btnConsultar,btnActualizar;
    ...
    public byte[] imageViewYoByte(ImageView imageView){
    ...
    public void llenarCampos(){
        ...
        imageInsert = imageViewYoByte(imgSelected);
